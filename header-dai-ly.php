    ...
    <div class="container-fluid">
      ...
      <div id="navbar" class="navbar-collapse collapse">
        <ul class="nav navbar-nav nav-bar-custom">
          ...
          <li class="nav-bar-item-5"><a href="#">Danh sách tàu</a></li>
          <li class="nav-bar-item-5"><a href="#">Các phòng đặt gần đây</a></li>
          <li class="nav-bar-item-5 is-active"><a href="man-hinh-cau-hoi-thuong-gap.php">Quản lý phòng</a></li>
