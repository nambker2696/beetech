...
;(function($, window, document, undefined) {
	...
	function bookedRemoveEmptyTRs(){
		"use strict";
		$('table.booked-calendar').find('http://hotcoffee-html.themerex.net/js/vendor/booked/tr.week').each(function(){
...
function adjust_calendar_boxes(){
	...
	jQuery('.booked-calendar').each(function(){
		...
		jQuery(this).find('http://hotcoffee-html.themerex.net/js/vendor/booked/tbody tr.week td .date').css('line-height',boxesHeight+'px');
