    ...
    <div class="top_panel_middle">
      <div class="content_wrap">
        <div class="contact_logo">
          <div class="logo">
            <a href="index.html">
              <img src="img/logo_beetech.png" class="logo_main" alt="" width="128" height="124">
              <img src="img/coffee/alternative-logo.png" class="logo_fixed" alt="" width="161" height="47">
            </a>
          </div>
        </div>
        <div class="menu_main_wrap">
          ...
          <nav class="menu_main_nav_area">
            <ul id="menu_main" class="menu_main_nav inited sf-js-enabled sf-arrows">
              <li class="menu-item menu-item-has-children"><a href="#" class="sf-with-ul">SẢN PHẨM</a>
              ...
              <li class="menu-item menu-item-has-children"><a href="#">GIÁ</a></li>
              <li class="menu-item menu-item-has-children"><a href="#">BẢN DÙNG THỬ</a></li>
              <li class="menu-item menu-item-has-children"><a href="#">CÂU HỎI THƯỜNG GẶP</a></li>
              <li class="menu-item menu-item-has-children"><a href="#">Ý KIẾN KHÁCH HÀNG</a></li>
              <li id="blob" style="width: 100px; height: 41px; left: 0px; top: 0px; background-color: rgb(0, 198, 255); opacity: 0;">
              </li>
            </ul>
          </nav>
        </div>
    ...
    <div class="panel_top">
      <nav class="menu_main_nav_area">
        <ul id="menu_main_mobile" class="menu_main_nav">
          ...
          <li class="menu-item menu-item-has-children"><a href="#"><span class="open_child_menu"></span>Reservations</a>
            <ul class="sub-menu">
              <li class="menu-item"><a href="calendar.html">Calendar</a></li>
              <li class="menu-item"><a href="tables.html">Tables Scheme</a></li>
            </ul>
          ...
          <li class="menu-item menu-item-has-children"><a href="#"><span class="open_child_menu"></span>Blog</a>
            <ul class="sub-menu">
              ...
              <li class="menu-item menu-item-has-children"><a href="#"><span class="open_child_menu"></span>Blog Masonry</a>
                <ul class="sub-menu">
          ...
          <li class="menu-item menu-item-has-children"><a href="#"><span class="open_child_menu"></span>Features</a>
            <ul class="sub-menu">
              <li class="menu-item menu-item-has-children"><a href="#"><span class="open_child_menu"></span>Tools</a>
                <ul class="sub-menu">
              ...
              <li class="menu-item menu-item-has-children"><a href="#"><span class="open_child_menu"></span>Gallery</a>
                <ul class="sub-menu">
