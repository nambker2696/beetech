...
<body>
  <div class="body_wrap">
    <div class="page_wrap">
      <div class="top_panel_fixed_wrap" style="height: 149px;"></div>
      ...
      <div class="page_content_wrap page_paddings_yes">
        ...
        Login success click ->
          <div class="content">
            <a href="daily-index.php" title="">Đại lý</a>  
            <br><br>
            <a href="member/index.php" title="">Member</a>
            <br><br>
            <a href="chutau/index.php" title="">Chủ tàu</a>
  ...
  <script type='text/javascript' src='js/coffee/custom.js'></script>
  <script type='text/javascript' src='js/coffee/superfish.js'></script>
  <script type='text/javascript' src='js/coffee/jquery.slidemenu.js'></script>
  <script type='text/javascript' src='js/coffee/core.utils.js'></script>
  <script type='text/javascript' src='js/coffee/core.init.js'></script>
